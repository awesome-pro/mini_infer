...
scripts/check_*.py      124 checks (no test framework — plain asserts)
...
for f in check_engine check_memory check_preemption check_metrics check_benchmark check_policies check_visualizations; do
  python scripts/$f.py
done
```
